...
resource kv 'Microsoft.KeyVault/vaults@2021-04-01-preview' = {
  name: 'azdemo101${suffix}-keyvault'
  location: location
  properties: {
    sku: {
      family: 'A'
...
resource swsadls 'Microsoft.Storage/storageAccounts@2021-04-01' = {
  name: 'azdemo101${suffix}synapsedl'
  location: location
  kind: 'StorageV2'
  sku: {
    name: 'Standard_LRS'
